...
nodes, hosted within a single subnet of an OCI tenancy as despicted in
Figure~\ref{fig:topology}. Each node is a \texttt{VM.Standard.A1.Flex}
instance with 1~OCPU (ARMv8), 6~GB of RAM and 50GB of storage, yielding a total cluster capacity
...
provenance tracking, and a visual pipeline editor. An NFS Gateway provides a
 mount point for batch file ingestion, allowing external systems to write data directly 
