...
of 4~OCPUs, 24~GB of RAM and 200GB of storage. The instances run OL9 (RHEL-compatible) on the aarch64
...
governance. The following four paragraphs examine each layer in that sequence,
relating the deployed ODP services to the responsibilities implied by the
diagram. Table~\ref{tab:odp-versions} lists the software versions assumed
