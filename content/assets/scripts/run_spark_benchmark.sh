...
# Executa as 14 consultas SSB no Spark SQL (SEM cache) usando UMA ÚNICA
# sessão spark-sql (um único SparkContext). Isso evita o overhead de
# inicializar o Spark 14 vezes e esgotar os recursos YARN.
#
# Uso:
...
echo " Executando 14 queries em sessão única"        | tee -a "$LOGFILE"
echo "=============================================" | tee -a "$LOGFILE"
