...
Q1.2b intentionally repeats Q1.2a to assess execution-time stability
...
-- Q1.2b (intentional repeat of Q1.2a)
SELECT sum(lo_extendedprice*lo_discount) as revenue FROM ssb.lineorder JOIN ssb.dwdate ON lo_orderdate = d_datekey WHERE d_yearmonthnum = 199401 AND lo_discount between 4 and 6 AND lo_quantity between 26 and 35;
...
\begin{figure}[p]
    ...
    \includegraphics[width=1.0\linewidth]{content/assets/graphic.pdf}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{@{} l c c c @{}}
    ...
    \hline
    Q1.2a &  541.5\,\pm 14.9 & 259.9\,\pm 11.1 & 311.0\,\pm 11.9 \\
    Q1.1  &  561.1\,\pm 23.0 & 203.0\,\phantom{0}\pm 9.7 & 298.7\,\pm 11.7 \\
    Q1.2b &  518.8\,\pm 21.9 & 213.0\,\phantom{0}\pm 7.9 & 299.4\,\pm 14.1 \\
...
282~seconds (Q1.2a) to 2{,}112~seconds (Q4.1). The SSB query catalogue is
structured into four groups of increasing join complexity. The first group
(Q1.1, Q1.2a, Q1.2b, Q1.3) performs single-join aggregations over \texttt{lineorder} and
\texttt{dwdate}; Hive averages 545~seconds per query whereas Spark averages
220~seconds, a roughly 2.5$\times$ speed-up. The second group (Q2.1--Q2.3) adds
...
249~seconds. The third group (Q3.1--Q3.4) joins \texttt{customer} and
...
(Q4.1--Q4.3) computes profit metrics over four-way joins and contains the
...
(Q1.1, Q1.2a, Q1.2b, Q1.3), the cached configuration was consistently slower, adding between
51~seconds (Q1.2a) and 96~seconds (Q1.1) of overhead per query. A similar penalty
applies to the three-way and four-way join queries Q2.1--Q2.3, where caching added
84--96~seconds, and to Q3.3, where the overhead was approximately 50~seconds. In
...
mean execution time by 297~seconds; Q3.1 gained 28~seconds, and Q3.4 through Q4.3
