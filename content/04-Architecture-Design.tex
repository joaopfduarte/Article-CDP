...
Upon successful deployment, the resulting architecture is organized into distinct, highly specialized functional layers. Figure~\ref{fig:arch-default} illustrates this conceptual design for the Default installation profile, demonstrating how the complex ecosystem of big data tools is structured to handle end-to-end data lifecycles.
