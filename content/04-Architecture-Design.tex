...
\begin{table}[htbp]
  ...
  \begin{tabular}{l p{8.5cm}}
    ...
    \hline
    \textbf{master.cdp (10.0.0.2)} & Ambari Server, HBase Master, HistoryServer, NameNode, Phoenix Query Server, Ranger Admin, Ranger UserSync, ResourceManager, Secondary NameNode, Spark 3 JobHistoryServer, ZooKeeper Server \\
    \textit{Master Node (Cluster Management, Core Masters)} & \\
    \hline
    \textbf{node1.cdp (10.0.0.3)} & DataNode, Hive Metastore, Hive Server, Kafka Broker, NFS Gateway, NiFi CA, NiFi Master, NodeManager, ZooKeeper Server \\
    \textit{Worker Node 1 (Data/Compute, specialized services)} & \\
    \hline
    \textbf{node2.cdp (10.0.0.4)} & DataNode, Kafka Broker, NodeManager, Spark 3 ThriftServer, ZooKeeper Server \\
    \textit{Worker Node 2 (Data/Compute, specialized services)} & \\
    \hline
    \textbf{node3.cdp (10.0.0.5)} & DataNode, HBase RegionServer, Kafka Broker, NodeManager, Ranger TagSync, Spark 3 Livy2 Server \\
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l p{8.5cm}}
    ...
    \textbf{Node \& Role} & \textbf{Installed Components} \\
    \hline
    \textbf{master.cdp (10.0.0.2)} & HistoryServer, NameNode, Ranger Admin, Ranger UserSync, ResourceManager, Secondary NameNode, Spark 3 JobHistoryServer, ZooKeeper Server \\
    \textit{Master Node (Cluster Management, Core Masters)} & \\
    \hline
    \textbf{node1.cdp (10.0.0.3)} & DataNode, Hive Metastore, Hive Server, Kafka Broker, NFS Gateway, NodeManager, ZooKeeper Server \\
    \textit{Worker Node 1 (Data/Compute, specialized services)} & \\
    \hline
    \textbf{node2.cdp (10.0.0.4)} & DataNode, Kafka Broker, NodeManager, Spark 3 ThriftServer, ZooKeeper Server \\
    \textit{Worker Node 2 (Data/Compute, specialized services)} & \\
    \hline
    \textbf{node3.cdp (10.0.0.5)} & DataNode, Kafka Broker, NodeManager, Ranger TagSync, Spark 3 Livy2 Server \\
    \textit{Worker Node 3 (Data/Compute, specialized services)} & \\
    \hline
  \end{tabular}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabular}{l p{8.5cm}}
    ...
    \textbf{Node \& Role} & \textbf{Installed Components} \\
    \hline
    \textbf{master.cdp (10.0.0.2)} & HBase Master, HistoryServer, NameNode, Phoenix Query Server, ResourceManager, Secondary NameNode, ZooKeeper Server \\
    \textit{Master Node (Cluster Management, Core Masters)} & \\
    \hline
    \textbf{node1.cdp (10.0.0.3)} & DataNode, NFS Gateway, NiFi CA, NodeManager, ZooKeeper Server \\
    \textit{Worker Node 1 (Data/Compute, specialized services)} & \\
    \hline
    \textbf{node2.cdp (10.0.0.4)} & DataNode, NiFi Master, NodeManager, ZooKeeper Server \\
    \textit{Worker Node 2 (Data/Compute, specialized services)} & \\
    \hline
    \textbf{node3.cdp (10.0.0.5)} & DataNode, HBase RegionServer, Kafka Broker, NodeManager \\
    \textit{Worker Node 3 (Data/Compute, specialized services)} & \\
    \hline
  \end{tabular}
\end{table}
