...
As a concluding remark on this test case, despite the severe hardware constraints, Spark demonstrated a flexible capability to consume available RAM effectively whilst falling back to disk allocations when necessary. However, owing to the strict infrastructural limits---primarily preventing the complete caching of the fact table---it is evident that the benchmark's performance could be substantially improved by provisioning greater RAM resources to the Spark engine.
