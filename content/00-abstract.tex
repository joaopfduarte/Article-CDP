...
Star Schema Benchmark (SSB) was executed under three
configurations, Hive, Spark, and Spark with caching, to evaluate query
performance on constrained hardware. Spark outperformed Hive, reducing mean query
execution times by 52\% to 86\%. In-memory caching degraded performance for
...
\KEYWORD{Big Data, Data Lake, Infrastructure as Code, Apache Hadoop, Apache Spark, Cloud Computing, ARM Architecture, Distributed Systems, Star Schema Benchmark, Cost Optimisation, Free Tier, Oracle Cloud Infrastructure, Apache Ambari, Data Governance.}
