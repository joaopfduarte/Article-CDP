...
\begin{frame}{Tempos m\'edios: Hive vs.\ Spark vs.\ Spark + cache}
  \begin{itemize}
    \item Spark \textbf{mais r\'apido que Hive} nas 13 consultas; diferen\c{c}a m\'edia da ordem de \textbf{centenas de segundos}/consulta.
...
\begin{frame}{N\'umeros de refer\^encia (m\'edia em 10 execu\c{c}\~oes)}
  ...
  \begin{cefetexampleblock}{S\'intese}
    Margem m\'edia Hive$\rightarrow$Spark na ordem de \textbf{$\sim$911~s} por consulta; em m\'edia global, Spark+cache fica \textbf{$\sim$18~s mais lento} que Spark sem cache --- cache n\~ao compensa na maioria dos casos neste teto de mem\'oria.
