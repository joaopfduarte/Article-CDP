...
\begin{frame}{Pipeline automatizado: fase 1 (Terraform)}
  ...
  \vspace{0.2em}
  \begin{center}
    \includegraphics[width=\linewidth,height=0.48\textheight,keepaspectratio]{provisioning-01-terraform.pdf}
  \end{center}
\end{frame}
