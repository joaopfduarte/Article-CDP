...
\begin{frame}{Topologia na OCI (4 n\'os ARM)}
  \begin{itemize}
    ...
    \item Oracle Linux 9 (OL9) \textbf{aarch64}; volumes para HDFS/logs.
...
\begin{frame}{Perfis de instala\c{c}\~ao}{Benchmark no perfil \textit{data science}}
  \begin{itemize}
    ...
    \item \textbf{Streaming profile}: NiFi/Kafka para ingest\~ao e eventos; HBase/Phoenix para acesso de baixa lat\^encia; sem Spark/Hive anal\'iticos.
  \end{itemize}
  \vspace{0.35em}
